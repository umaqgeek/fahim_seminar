...
<div class="row">
	<div class="col-md-8">
		<!--<div class="form-group col-md-offset-1">
          <label for="storageLocation" class="col-sm-1 control-label"><strong>HAHA</strong></label>
          <div class="col-sm-3">
          	<input name="haha" type="text" class="form-control" placeholder="haha" />
          </div>
        </div>-->
		<?php
		echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			...
			<input type="button" value="<?php echo $this->l('form_update_changes'); ?>" class="btn btn-dinarpal submit-form"/>
			<?php 	if(!$this->unset_back_to_list) { ?>
				<input type="button" value="<?php echo $this->l('form_update_and_go_back'); ?>" id="save-and-go-back-button" class="btn btn-dinarpal"/>
				<input type="button" value="<?php echo $this->l('form_cancel'); ?>" data-target-url="<?php echo $list_url?>" class="btn btn-dinarpal return-to-list" />
			<?php 	} ?>
