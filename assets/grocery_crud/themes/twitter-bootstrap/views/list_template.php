	...
	<div id="main-table-box">
		...
		<div id="options-content" class="span12">
			...
			if(!$unset_add || !$unset_export || !$unset_print){?>
				<?php if(!$unset_add){?>
					<a href="<?php echo $add_url?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject?>" class="add-anchor btn btn-dinarpal">
						<!--<i class="icon-plus"></i> -->
 			...
 			<a class="btn btn-dinarpal" data-toggle="modal" href="#filtering-form-search" >
		...
		<div id="message-box" class="span12">
			<div class="alert alert-sucess <?php echo ($success_message !== null) ? '' : 'hide-table'; ?>">
...
<div class="modal hide-table" id="filtering-form-search">
