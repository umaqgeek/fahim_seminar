...
<div class="twitter-bootstrap crud-form">
	...
	<div id="main-table-box span12">
		...
		echo form_open( $insert_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			...
			<input type="button" value="<?php echo $this->l('form_save'); ?>"  class="btn btn-dinarpal submit-form"/>
			<?php 	if(!$this->unset_back_to_list) { ?>
				<input type="button" value="<?php echo $this->l('form_save_and_go_back'); ?>" id="save-and-go-back-button"  class="btn btn-dinarpal"/>
				<input type="button" value="<?php echo $this->l('form_cancel'); ?>" class="btn btn-dinarpal return-to-list" />
			<?php 	} ?>
